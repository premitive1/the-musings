...
In the adversarially titled "Buying versus Donating", developer fiatjaf
makes the argument that love of a donation based business model "is very
misguided" and later concludes, "donations are much more complicated
than purchases, and that repeating the *value for value* mantra doesn't
help at all." Finally, he suggests "bitcoiners should give more
attention to other models, in which people produce goods and services
and sell them...that model can be applied successfully to *content
creators*...probably better than the donation model.” The reason he
argues this is that, "the idea that the listener is capable of measuring
the value it gets from the podcast...is completely wrong and
nonsensical.” To him it seems that if the open sharing model depends on
recipients of content deciding for themselves how much to *pay for the
product* most content producers won't make any money. As a passionate
advocate for use of the value for value model I find myself pondering
the points fiatjaf makes. While agreeing with most of their premises, I
do not take all of them for granted, and therefore reach alternative
conclusions.
